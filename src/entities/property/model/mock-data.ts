...
// 50 unique Unsplash photo IDs for property images - verified working IDs
const uniquePhotoIds = [
  ...
  'photo-1600585154340-be6161a56a0c', 'photo-1600607687644-aac4cc92b3ec', 'photo-1586023492125-27b2c045efd7',
  ...
  'photo-1600585154363-67eb9e2e2099', 'photo-1493663284031-b7e3adf4808e', 'photo-1494526585095-c41746248156',
  ...
  'photo-1588854337236-6889d631faa8', 'photo-1592595896616-c37162298647', 'photo-1601760562234-9814eea6663a',
  'photo-1605276373954-0c4a0dac5cc0', 'photo-1613490493576-7fde63acd811', 'photo-1613977257363-707ba9348227',
  'photo-1616486338812-3dadae4b4ace', 'photo-1628744448840-55bdb2497bd4', 'photo-1630699144867-37acec97df5a',
  'photo-1631049307264-da0ec9d70304', 'photo-1631049421857-465af1e3a12d', 'photo-1633505322744-5f9ad47651e4',
  'photo-1636378885639-0e1c59bf89b5', 'photo-1640806846959-5dd39e0965e6', 'photo-1641141635536-4df51b82e7c6',
  'photo-1648737154547-b0dfd281c51e', 'photo-1653408400813-6e0beacbedf9', 'photo-1658967742784-b7b9b7c7b6b4'
] as const;
...
export const mockProperties: Property[] = Array.from({ length: 50 }, (_, index) => {
  ...
  return {
    ...
    images: [`https://images.unsplash.com/${uniquePhotoIds[index]}?w=800&h=600&fit=crop&auto=format&q=80`],
    agent,
    createdAt,
    updatedAt
  };
