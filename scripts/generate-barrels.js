...
function generateBarrelFile(dirPath) {
  ...
  if (shouldWrite) {
    ...
    console.log(`✓ Generated barrel: ${relative(ROOT_DIR, indexPath)}`);
  } else {
...
function generateAllBarrels() {
  console.log('🚀 Generating barrel files for FSD layers...\n');
  ...
  for (const layer of FSD_LAYERS) {
    ...
    if (existsSync(layerPath)) {
      ...
      console.log(`⚠️  Layer directory not found: ${layer}`);
    }
  }
...
function watchMode() {
  ...
  function checkForChanges() {
    ...
    if (hasChanges) {
      console.log('\n📝 Files changed, regenerating barrels...');
      generateAllBarrels();
    }
  }
